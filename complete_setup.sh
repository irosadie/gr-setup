...
main() {
    ...
    # Step 1: Check prerequisites and system requirements
    ...
    echo -e "\n${YELLOW}=== Step 2: Docker Installation ===${NC}"
    install_docker
    install_docker_compose
    install_make
    
    # Step 3: Interactive configuration (RUN FIRST)
    echo -e "\n${YELLOW}=== Step 3: Interactive Configuration ===${NC}"
    interactive_setup
